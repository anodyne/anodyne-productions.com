                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        <a :href="$route('home')" class="flex-shrink-0 flex items-center">
                            ...
                            <anodyne-logo class="block h-8 w-auto text-blue-500"></anodyne-logo>
                        </a>

                        <!-- Desktop header nav -->
                        <div class="hidden | sm:ml-6 sm:flex">
                            <inertia-link :href="$route('account.info')" class="inline-flex items-center px-1 pt-1 border-b-2 border-blue-500 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-blue-700 transition duration-150 ease-in-out">
                                Account
                            </inertia-link>
                            <a href="https://xtras.anodyne-productions.com" class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                Xtras
                            </a>
                            <a href="https://help.anodyne-productions.com" class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                Docs
                            </a>
                            <inertia-link :href="$route('admin.dashboard')" class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                Admin
                            </inertia-link>
                        </div>
                    </div>
                    ...
                    <div class="hidden | sm:ml-6 sm:flex sm:items-center">
                        ...
                        <dropdown placement="bottom-end" class="ml-3">
                            ...
                            <template #dropdown="{ toggle, styles }">
                                ...
                                <a href="#" :class="styles.link">Sign Out</a>
                            </template>
                        </dropdown>
                    </div>
                        ...
                        <div class="px-4 border-b border-gray-200 | sm:px-6">
                            <nav class="flex -mb-px">
                                <inertia-link
                                    ...
                                    class="group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm leading-5 focus:outline-none transition ease-in-out duration-150"
                                    :class="tabStyles('account.info')"
                                >
                                    <svg
                                        class="-ml-0.5 mr-2 h-5 w-5"
                                        :class="tabIconStyles('account.info')"
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                    >
                                        <path
                                ...
                                <inertia-link
                                    ...
                                    class="ml-8 group inline-flex items-center py-4 px-1 border-b-2 font-medium text-sm leading-5 focus:outline-none transition ease-in-out duration-150"
                                    :class="tabStyles('account.delete')"
                                >
                                    <svg
                                        class="-ml-0.5 mr-2 h-5 w-5"
                                        :class="tabIconStyles('account.delete')"
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                    >
                                        <path
...
export default {
    ...
    methods: {
        tabIconStyles (route) {
            return {
                'text-blue-500 group-hover:text-blue-500 group-focus:text-blue-600': this.$route().current(route),
                'text-gray-400 group-hover:text-gray-500 group-focus:text-gray-600': this.$route().current(route)
            };
        },

        tabStyles (route) {
            return {
                'border-blue-500 text-blue-600 focus:text-blue-800 focus:border-blue-700': this.$route().current(route),
                'border-transparent text-gray-500 focus:text-blue-800 focus:border-blue-700 hover:text-gray-700 hover:border-gray-300 focus:text-gray-700 focus:border-gray-300': !this.$route().current(route)
            };
        }
    }
};
