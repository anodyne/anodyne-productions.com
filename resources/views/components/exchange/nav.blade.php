    ...
    <div>
        <div class="px-3">
            <div class="relative rounded-md shadow-sm">
                ...
                <input type="text" name="email" id="email" class="focus:ring-light-blue-500 focus:border-light-blue-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md" placeholder="Find an item...">
            </div>
        </div>
    </div>
