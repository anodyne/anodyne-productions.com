...
<div x-data="{'version': '{{ $version }}', 'genre': ''}">
    <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <a name="download"></a>
        <div class="bg-anodyne-orange-4 rounded-lg shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
            <div class="pt-10 pb-12 px-6 sm:pt-16 sm:px-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
                <div class="lg:self-center">
                    ...
                    <div class="mt-6 flex flex-col lg:flex-row lg:items-center justify-between space-y-6 lg:space-y-0 lg:space-x-6">
                        ...
                        <div class="flex-1">
                            <div>
                                <label for="genre" class="block text-sm font-medium text-black text-opacity-50">Genre</label>
                    ...
                    <div x-show="version === '2.3.2'" class="mt-8 flex space-x-3 text-white font-medium text-sm leading-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-7 w-7 flex-shrink-0 text-black text-opacity-50"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
