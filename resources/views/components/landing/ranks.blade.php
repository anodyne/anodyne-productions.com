...
<x-landing-section
    ...
    icon="st-army-badge"
>
    <x-slot name="heading">Ranks</x-slot>
    <x-slot name="title">Ranks. Done right.</x-slot>
    <x-slot name="content">A re-imagined system for handling ranks makes it infinitely easier to manage your ranks and build them exactly how you want them.</x-slot>
