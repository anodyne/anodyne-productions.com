...
@if ($gradient)
    <svg viewBox="0 0 408 350" fill="none" xmlns="http://www.w3.org/2000/svg" {{ $attributes }}><path fill-rule="evenodd" clip-rule="evenodd" d="M121.396 349.947l-42.179-69.978L243.141.052h-81.962L.61 279.969l39.304 69.978h81.482zm211.854 0l-40.262-74.772h-94.903l46.973-90.109-38.345-71.897-91.069 168.717 39.303 68.061H333.25zM223.968 82.494l33.552-62.31 149.87 260.447-38.991 69.316L223.968 82.494z" fill="url(#prefix__paint0_linear)"/><defs><linearGradient id="prefix__paint0_linear" x1=".61" y1="174.999" x2="407.39" y2="174.999" gradientUnits="userSpaceOnUse"><stop stop-color="#F2634C"/><stop offset="1" stop-color="#F99C26"/></linearGradient></defs></svg>
@else
