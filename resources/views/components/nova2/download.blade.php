    ...
    <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-gradient-to-br from-orange-500 to-amber-500 rounded-2xl shadow-xl overflow-hidden lg:grid lg:grid-cols-2 lg:gap-4">
            ...
            <div class="-mt-6 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1">
                <img class="transform translate-x-6 translate-y-6 rounded-xl object-cover object-left-top sm:translate-x-12 lg:translate-y-20" src="{{ Storage::url('images/nova2-admin.webp') }}" alt="Nova 2 admin screenshot">
            </div>
        </div>
    </div>
</div>