            ...
            <div class="max-w-xl mx-auto lg:max-w-7xl">
                <dl class="space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
                    <x-nova2.feature title="All-In-One Website" text="Nova gives your game a dedicated website with all of the content you and your players create to show off your game to the world.">
                        <x-slot name="icon">
                            @svg('fluent-app-generic', 'h-8 w-8')
                        </x-slot>
                    </x-nova2.feature>

                    <x-nova2.feature title="Characters" text="Manage all of your game's characters in one place and let players take ownership of the characters they play.">
                        <x-slot name="icon">
                            @svg('fluent-people-community', 'h-8 w-8')
                        </x-slot>
                    </x-nova2.feature>
                    ...
                    <x-nova2.feature title="Tell Your Stories" text="At the heart of Nova is an integrated story and posting system that gives your players the freedom to tell your game's stories.">
                        <x-slot name="icon">
                            @svg('fluent-calligraphy-pen', 'h-8 w-8')
                        </x-slot>
                    </x-nova2.feature>
                    ...
                    <x-nova2.feature title="Reporting" text="Get valuable insight into activity, posting levels, player averages, and even forecasting posting for the rest of the month.">
                        <x-slot name="icon">
                            @svg('fluent-data-histogram', 'h-8 w-8')
                        </x-slot>
                    </x-nova2.feature>

                    <x-nova2.feature title="Customizable" text="Whether it's changing the way it looks or the way it works, Nova gives you the tools to customize your site any way you want.">
                        <x-slot name="icon">
                            @svg('fluent-settings', 'h-8 w-8')
                        </x-slot>
                    </x-nova2.feature>
                </dl>
            </div>
