                ...
                <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                    <div class="px-4 sm:px-6 lg:px-8 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                        <div>
                            <a href="{{ route('nova-3') }}" class="inline-flex items-center text-white bg-gray-900 rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200">
                                <span class="px-3 py-0.5 text-white text-xs font-semibold leading-5 uppercase tracking-wide bg-gradient-to-r from-orange-500 to-amber-500 rounded-full">Nova 3 is coming</span>
                    ...
                    <div class="mt-16 sm:mt-24 lg:mt-0 lg:col-span-6">
                        <div class="-mt-6 aspect-w-4 aspect-h-3">
                            <img src="{{ asset('images/nova2-manifest.webp') }}" alt="App screenshot" class="transform translate-x-0 translate-y-6 md:rounded-xl object-cover object-left-top sm:translate-x-40 lg:translate-y-0">
                        </div>
                    </div>
                </div>
            </div>
