<div class="relative max-w-7xl mx-auto pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
    ...
    <div class="mt-12 max-w-lg mx-auto grid gap-x-6 gap-y-12 lg:grid-cols-{{ config('services.anodyne.exchange') ? '3' : '2' }} lg:max-w-none">
        <x-nova2.components.resource :href="route('docs')" category="Documentation" title="Learn all about Nova 2">
        ...
        </x-nova2.components.resource>

        <x-nova2.components.resource href="https://discord.gg/7WmKUks" target="_blank" category="Community" title="Join the community">
        ...
        @if (config('services.anodyne.exchange'))
            <x-nova2.components.resource :href="route('exchange.index')" category="Exchange" title="Make Nova your own">
