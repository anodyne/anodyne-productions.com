    ...
    <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
        ...
        <div class="mt-12 sm:mt-16 lg:mt-0 {{ $right ? 'lg:col-start-1' : '' }}">
            <div class="lg:px-0 lg:m-0 lg:relative lg:h-full {{ $right ? 'pr-4 -ml-48 sm:pr-6 md:-ml-16' : 'pl-4 -mr-48 sm:pl-6 md:-mr-16' }}">
                <img class="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute {{ $right ? 'lg:right-0' : 'lg:left-0' }} lg:h-full lg:w-auto lg:max-w-none" src="{{ Storage::url($image) }}" alt="screenshot">
            </div>
        </div>
    </div>
</div>