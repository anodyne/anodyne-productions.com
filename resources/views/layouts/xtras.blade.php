...
@section('template')
    <div class="flex flex-col justify-between h-screen">
        <div>
            <nav class="flex items-center relative z-10 bg-white shadow-md py-3">
                <div class="container">
            ...
            {{-- <section class="w-1/2 bg-white rounded px-6 py-3 shadow-lg mx-auto -mt-20 mb-12">
                <div class="flex items-center justify-between">
                    <input type="text" name="search" class="w-full mr-6 appearance-none focus:outline-none py-3" placeholder="Search">
                    <button class="py-2 px-4 rounded bg-yellow-400 font-medium text-yellow-900">Search</button>
                </div>
            </section> --}}
            ...
            <div class="container">
                <div class="flex mb-12">
                    <nav class="w-64 mr-8">
                        <a href="#" class="flex items-center w-full p-3 rounded leading-none no-underline text-grey-500 font-medium mb-4 bg-white border">
                            <app-icon name="single-neutral-actions" class="h-5 w-5 mr-3 text-grey-400"></app-icon>
                            My Info
                        </a>
                        <a href="#" class="flex items-center w-full p-3 rounded leading-none no-underline text-grey-500 font-medium mb-4">
                            <app-icon name="settings-toggle-horizontal" class="h-6 w-6 mr-3 text-grey-400"></app-icon>
                            Preferences
                        </a>
                        <a href="#" class="flex items-center w-full p-3 rounded leading-none no-underline text-grey-500 font-medium mb-4">
                            <app-icon name="alarm-bell" class="h-6 w-6 mr-3 text-grey-400"></app-icon>
                            Notifications
                        </a>
                        <a href="#" class="flex items-center w-full p-3 rounded leading-none no-underline font-medium mb-4 bg-red-50 text-red-500">
                            <app-icon name="bin-2-alternate" class="h-6 w-6 mr-3 text-red-400"></app-icon>
                            Delete My Account
                        </a>
                    </nav>
