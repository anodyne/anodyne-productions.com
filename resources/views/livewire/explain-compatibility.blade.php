<div class="flex flex-col h-full">
  <div class="p-4 sm:px-6 sm:py-5">
    <div class="flex items-center space-x-2">
      ...
      <h3 class="text-lg/4 font-display font-semibold text-slate-900 dark:text-white">How does compatibility work?</h3>
    </div>
