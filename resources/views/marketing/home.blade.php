    ...
    <section class="py-6">
        <div class="container">
            <div class="text-center">
                <div class="text-blue-500 text-3xl">Headline</div>
                <div class="mb-6 text-grey-600">Sub-headline with some supporting text here.</div>
            </div>
            ...
            <div class="flex">
                <div class="flex-1">
                    ...
                    <div class="text-lg font-medium text-blue-500 mb-2">Feature 1</div>
                ...
                <div class="flex-1 mx-8">
                    ...
                    <div class="text-lg font-medium text-blue-500 mb-2">Feature 2</div>
                ...
                <div class="flex-1">
                    ...
                    <div class="text-lg font-medium text-blue-500 mb-2">Feature 3</div>
