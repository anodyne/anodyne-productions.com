<x-layouts.projects prose>
    ...
    <div class="divide-y-2 divide-white rounded-2xl overflow-hidden shadow-lg">
        <div class="flex space-x-8 text-white font-bold tracking-tight text-2xl">
            <div class="flex justify-between flex-1 p-6 bg-gradient-to-r from-orange-500 to-amber-500">
                <span>Sango Red</span>
        ...
        <div class="flex space-x-0.5 text-white font-semibold text-lg">
            <div class="bg-spanish-roast flex-1 p-3">Spanish Roast</div>
            <div class="bg-blue-500 flex-1 p-3">Parkwater</div>
            <div class="bg-green-500 flex-1 p-3">Mint Leaf</div>
            <div class="bg-red-500 flex-1 p-3">American Red</div>
        </div>
    </div>
