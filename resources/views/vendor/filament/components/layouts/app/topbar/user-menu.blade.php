    ...
    >
        <div>
            @if (config('filament.dark_mode'))
                <x-filament::dropdown.list.item icon="flex-weather-moon" x-show="theme === 'dark'" x-on:click="close(); mode = 'manual'; theme = 'light'">
                    {{ __('filament::layout.buttons.light_mode.label') }}
                </x-filament::dropdown.list.item>

                <x-filament::dropdown.list.item icon="flex-weather-sun" x-show="theme === 'light'" x-on:click="close(); mode = 'manual'; theme = 'dark'">
