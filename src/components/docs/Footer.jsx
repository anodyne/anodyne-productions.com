  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-slate-900/5 pt-8 dark:border-white/5 sm:flex-row">
      ...
      <div className="flex gap-4">
        <SocialLink href="https://twitter.com/anodyneprod" icon={TwitterIcon}>
          Follow us on Twitter
        </SocialLink>
        <SocialLink href="https://github.com/anodyne" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
        <SocialLink href="https://discord.gg/7WmKUks" icon={DiscordIcon}>
