  ...
  return (
    <>
      ...
      <button
        ...
        {...props}
      >
        <SearchIcon className="h-5 w-5 stroke-slate-600 dark:stroke-white" />
      </button>
    </>
  )
}
...
export function MobileSearch() {
  ...
  return (
    <div className="contents lg:hidden">
      <button
        type="button"
        className="flex h-9 w-9 items-center justify-center rounded-md transition hover:bg-slate-900/5 dark:hover:bg-white/5 lg:hidden focus:[&:not(:focus-visible)]:outline-none"
        aria-label="Find something..."
        {...buttonProps}
      >
        <SearchIcon className="h-7 w-7 stroke-slate-600 dark:stroke-white" />
      </button>
