...
const variantStyles = {
   ...
   outline: {
      none: '',
      slate: 'ring-slate-900/20 text-slate-600 hover:text-slate-900 hover:ring-slate-900/50 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300',
