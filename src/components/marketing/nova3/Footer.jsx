...
export function Footer() {
   return (
      <footer className="bg-slate-900">
         <Container>
            <div className="py-16">
               <AnodyneLogo className="mx-auto h-6 w-auto text-slate-500" />
            ...
            <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
               <div className="flex items-center gap-x-6">
                  ...
                  >
                     <svg aria-hidden="true" className="h-6 w-6 fill-slate-600 group-hover:fill-slate-500">
                  ...
                  >
                     <svg viewBox="0 0 569 546" xmlns="http://www.w3.org/2000/svg" className="h-4 w-auto fill-slate-600 group-hover:fill-slate-500"><g><circle cx="362.589996" cy="204.589996" r="204.589996"></circle><rect height="545.799988" width="100" x="0" y="0"></rect></g></svg>
                  </Link>
               </div>
