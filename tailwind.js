...
module.exports = {
  ...
  */
    ...
    modules: {
        ...
        textColors: ["responsive", "hover", "focus-within"],
  ...
  */
    ...
    plugins: [
        ...
        function({ addUtilities }) {
            const textShadows = {
                ".text-shadow": {
                    "text-shadow": "0 1px 3px rgba(50,50,93,.15)"
                },
                ".text-shadow-md": {
                    "text-shadow": "0 4px 6px rgba(50,50,93,.11)"
                },
                ".text-shadow-lg": {
                    "text-shadow": "0 18px 35px rgba(50,50,93,.1)"
                },
                ".text-shadow-none": {
                    "text-shadow": "none"
                }
